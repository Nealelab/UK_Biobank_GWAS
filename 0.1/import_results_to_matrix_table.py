...
both_sexes_set = set(phenotypes_both_sexes.phenotype.collect())
female_set = set(phenotypes_female.phenotype.collect())
male_set = set(phenotypes_male.phenotype.collect())
...
for phenotype in union_set:
    ...
    ht.write('gs://ukb31063-mega-gwas/results-hail-tables/{}.ht'.format(phenotype), overwrite=True)
