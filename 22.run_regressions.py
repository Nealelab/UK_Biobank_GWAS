...
vds_variants = hc.read('gs://ukb31063-mega-gwas/hail-0.1/qc/ukb31063.gwas_variants.{}.with_qc_annotations.vds'.format(contig))
...
if pipeline_type == 'curated':
    kt_phenotype = hc.read_table('gs://ukb31063-mega-gwas/hail-0.1/phenotype-pipelines/curated/ukb31063.{}.curated.kt'.format(sex))
else:
    kt_phenotype = hc.read_table('gs://ukb31063-mega-gwas/hail-0.1/phenotype-pipelines/{0}/ukb31063.{1}.{0}.pipeline.{2}.kt'.format(pipeline_type, sex, pipeline_number))
...
vds = (hc.import_bgen('gs://fc-7d5088b4-7673-45b5-95c2-17ae00a04183/imputed/ukb_imp_chr{}_v3.bgen'.format(import_expr),
                      sample_file='gs://phenotype_31063/ukb31063.imputed_v3.{}.sample'.format(contig),
                      tolerance=0.2)
...
if pipeline_type == 'curated':
    path = 'gs://ukb31063-mega-gwas/hail-0.1/results-tables/curated/ukb31063.{0}.curated.{1}.kt'.format(sex, contig)
else:
    path = 'gs://ukb31063-mega-gwas/hail-0.1/results-tables/{0}/ukb31063.{1}.{0}.{2}.pipeline.{3}.kt'.format(pipeline_type, sex, contig, pipeline_number)
